...
const TimelineActivityCard = ({ type, imgSrc, title, description, startTime, endTime, rating, neighborhood }) => (
    <div className="h-48 flex flex-col bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800">
